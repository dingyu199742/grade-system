...
public class FindAllNewsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Map<String, Information> map=new LinkedHashMap <String, Information>();
		
		map=id.findAllInformation();
	
		request.setAttribute("news", map);
		if (u.equals("user")){
			request.getRequestDispatcher("/showNoticeBoard.jsp").forward(request, response);
		}else{
