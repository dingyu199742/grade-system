			...
			<div class="information-content content" style="height:auto">
				...
				<!-- <form> -->
		        	...
		        	<div class="unit-information">
						...
						<form class="form-horizontal" action="/grade_srdp/updateCourseServlet" method="post">
								...
								<div class="list fr"><label>课程名</label> : <input type="text" name="name" value=<%=course.getCname()%> required="required" /></div>
								<div class="list fr"><label>学分</label> : <input type="text" name="credit" value=<%=course.getCredit()%> pattern="^[0-9]+(.[0-9]{1})?$" required="required" /></div>
