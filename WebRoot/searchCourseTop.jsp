   ...
   <div class="information-content content" style="margin-left:141px">
     ...
     <div class="unit-information">
		<div class="unit">
	        ...
	        <p class="unit-content">课程信息查询：</p>
	    </div>
		<form style="margin-left:20px" action="/grade_srdp/searchOneCourseServlet" method="post" target="main">
	       课程号：<input type="text" id="searchstr" name="ccode" class="textbox" size="20">  
	       课程名：<input type="text" id="searchstr" name="cname" class="textbox" size="20"> 
